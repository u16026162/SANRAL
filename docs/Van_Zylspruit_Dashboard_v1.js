...
async function startApplication() {
  ...
  const env_spec = ['https://cdn.holoviz.org/panel/0.14.2/dist/wheels/bokeh-2.4.3-py3-none-any.whl', 'https://cdn.holoviz.org/panel/0.14.2/dist/wheels/panel-0.14.2-py3-none-any.whl', 'pyodide-http==0.1.0', 'holoviews>=1.15.1', 'holoviews>=1.15.1', 'hvplot', 'matplotlib', 'numpy', 'pandas']
...
start_date = df["Date_Time"].dropna().to_numpy()[0]
end_date = df["Date_Time"].dropna().to_numpy()[-2]
...
multi_select = pn.widgets.MultiSelect(
                ...
                #value = ["A1", "A2", "A3", "A4", "A5", "A6", "A7", "A8", "A9", "A10", "A11"],
...
# Data:
ihvplot = (
            ipipeline.hvplot(x = "Date_Time", y = multi_select,
